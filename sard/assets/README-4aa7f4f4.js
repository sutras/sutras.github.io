import{j as l,a as s,F as u,R as n}from"./index-b9ddf759.js";import{I as i,B as v,D as t}from"./index-cef2ca44.js";import{c as x}from"./index-2e4736b8.js";import"./index.es-5a450476.js";const q={success:"check-circle-fill",info:"info-circle-fill",warning:"warning-fill",error:"x-octagon-fill",question:"question-circle-fill"},a=m=>{const{className:g,children:p,status:o="info",icon:h,title:c,description:e,...f}=m,y=x("s-result",`s-result-${o}`,g);return l("div",{...f,className:y,children:[s("div",{className:"s-result-icon",children:h??s(i,{prefix:"si",name:q[o]})}),c&&s("div",{className:"s-result-title",children:c}),e&&s("div",{className:"s-result-description",children:e}),p&&s("div",{className:"s-result-extra",children:p})]})};function k(){return l("div",{style:{display:"flex",flexDirection:"column",gap:30},children:[s(a,{status:"success",title:"成功",description:"请根据提示进行操作"}),s(a,{status:"info",title:"信息",description:"请根据提示进行操作"}),s(a,{status:"warning",title:"警告",description:"请根据提示进行操作"}),s(a,{status:"error",title:"错误",description:"请根据提示进行操作"}),s(a,{status:"question",title:"疑惑",description:"请根据提示进行操作"})]})}const w={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function r(){return s(u,{children:s(a,{status:"success",title:"成功",description:"请根据提示进行操作",children:s(v,{children:"返回首页"})})})}const R={doc:`<h3>额外内容</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function d(){return s(u,{children:s(a,{icon:s(i,{name:"bi-cup-hot",color:"var(--s-tertiary-color)"}),title:"稍候",description:"请根据提示进行操作"})})}const E={doc:`<h3>自定义图标</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};k.doc=w;r.doc=R;d.doc=E;function F(){return n.createElement("div",{className:"doc-content"},n.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="result-jie-guo">Result 结果<a class="doc-anchor" href="#result-jie-guo">#</a></h1>
