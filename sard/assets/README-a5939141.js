import{a as n,F as t,j as p,K as s,r as A,I as e,R as a}from"./index-b8e75f22.js";import{D as c}from"./Demo-3b19c6f8.js";import"./index.es-833d515d.js";function l(){return n(t,{children:p(s,{children:[n(s.Item,{title:"标题1",children:"内容1"}),n(s.Item,{title:"标题2",children:"内容2"}),n(s.Item,{title:"标题3",children:"内容3"})]})})}const y={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function u(){return n(t,{children:p(s,{defaultActiveKey:1,children:[n(s.Item,{title:"标题1",children:"内容1"}),n(s.Item,{title:"标题2",children:"内容2"}),n(s.Item,{title:"标题3",children:"内容3"})]})})}const x={doc:`<h3>默认展开</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function k(){return n(t,{children:p(s,{multiple:!0,defaultActiveKey:[0,1],children:[n(s.Item,{title:"标题1",children:"内容1"}),n(s.Item,{title:"标题2",children:"内容2"}),n(s.Item,{title:"标题3",children:"内容3"})]})})}const v={doc:`<h3>展开多个</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Accordion <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function i(){const[o,g]=A.useState(0);return n(t,{children:p(s,{activeKey:o,onChange:h=>{g(h)},children:[n(s.Item,{title:"标题1",children:"内容1"}),n(s.Item,{title:"标题2",children:"内容2"}),n(s.Item,{title:"标题3",children:"内容3"})]})})}const I={doc:`<h3>受控</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Accordion <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-accordion-item-icon-font-size</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-text-base<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">--s-accordion-item-icon-color</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-tertiary-color<span class="token punctuation">)</span><span class="token punctuation">;</span>
