import{r as o,j as k,F as r,a as n,R as t}from"./index-b9ddf759.js";import{B as a,p as d,D as g}from"./index-cef2ca44.js";import"./index-2e4736b8.js";import"./index.es-5a450476.js";function c(){const[e,p]=o.useState(!1),[u,l]=o.useState("center"),s=i=>{p(!0),l(i)};return k(r,{children:[n(a,{onClick:()=>s("top"),children:"顶部"})," ",n(a,{onClick:()=>s("right"),children:"右边"})," ",n(a,{onClick:()=>s("bottom"),children:"底部"})," ",n(a,{onClick:()=>s("left"),children:"左边"})," ",n(a,{onClick:()=>s("center"),children:"居中"})," ",n(a,{onClick:()=>s("center-fade"),children:"居中淡入淡出"}),n(d,{visible:e,placement:u,onMaskClick:()=>{p(!1)},children:n("div",{style:{padding:"20px",background:"var(--s-emphasis-bg)"},children:"Popup"})})]})}const h={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};c.doc=h;function v(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="popup-tan-chu-ceng">Popup 弹出层<a class="doc-anchor" href="#popup-tan-chu-ceng">#</a></h1>
