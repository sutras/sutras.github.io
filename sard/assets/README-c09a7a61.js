import{c as C,j as p,a,I as D,F as o,R as n}from"./index-b8e75f22.js";import{D as t}from"./Demo-3b19c6f8.js";import"./index.es-833d515d.js";const s=g=>{const{className:m,children:y,theme:h="default",plain:f,round:x,mark:w,size:v="medium",closable:T,onClose:E,...b}=g,B=C("s-tag",`s-tag-${h}`,`s-tag-${v}`,{"s-tag-plain":f,"s-tag-round":x,"s-tag-mark":w},m);return p("div",{...b,className:B,children:[y,T&&a(D,{className:"s-tag-close",prefix:"si",name:"close",onClick:E})]})};function e(){return a(o,{children:a(s,{children:"标签"})})}const q={doc:`<h3>基础使用</h3>
