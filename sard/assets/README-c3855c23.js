import{j as t,$ as a,a as n,r as e,I as m,F as g,k as b,R as s}from"./index-be529937.js";import{D as o}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function l(){return t(a,{defaultActiveKey:0,fixed:!1,children:[n(a.Item,{icon:{name:"bi-house-door-fill"},children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})}const h={doc:`<h3>基础使用</h3>
