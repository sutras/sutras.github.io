import{j as p,n as a,a as n,r as v,I as y,R as s}from"./index-be529937.js";import{D as t}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function e(){return p(a.Group,{defaultValue:"normal",children:[n(a,{value:"normal",children:"正常"}),n(a,{value:"abnormal",children:"异常"})]})}const f={doc:`<h3>基础用法</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};e.doc=f;c.doc=R;l.doc=E;u.doc=w;k.doc=x;i.doc=b;r.doc=C;d.doc=F;function G(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="radio-dan-xuan-an-niu">Radio 单选按钮<a class="doc-anchor" href="#radio-dan-xuan-an-niu">#</a></h1>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-radio-icon-color</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-quaternary-color<span class="token punctuation">)</span><span class="token punctuation">;</span>
