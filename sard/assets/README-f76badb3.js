import{r as o,j as k,F as r,a as n,R as t}from"./index-093297df.js";import{B as a,t as d,D as g}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import"./index.es-471f4c94.js";function c(){const[e,p]=o.useState(!1),[u,l]=o.useState("center"),s=i=>{p(!0),l(i)};return k(r,{children:[n(a,{onClick:()=>s("top"),children:"顶部"})," ",n(a,{onClick:()=>s("right"),children:"右边"})," ",n(a,{onClick:()=>s("bottom"),children:"底部"})," ",n(a,{onClick:()=>s("left"),children:"左边"})," ",n(a,{onClick:()=>s("center"),children:"居中"})," ",n(a,{onClick:()=>s("center-fade"),children:"居中淡入淡出"}),n(d,{visible:e,placement:u,onMaskClick:()=>{p(!1)},children:n("div",{style:{padding:"20px",background:"white"},children:"Popup"})})]})}const h={doc:`<h3>基础使用</h3>
