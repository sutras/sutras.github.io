import{r as i,j as l,F as k,a as n,R as t}from"./index-b9ddf759.js";import{B as g,D as c}from"./index-cef2ca44.js";import"./index-2e4736b8.js";import{S as a}from"./index-797f93d5.js";import"./index.es-5a450476.js";function m(){const[s,p]=i.useState(50);return l(k,{children:[n(a,{defaultValue:s,onChange:o=>{p(o)}}),s]})}const j={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};m.doc=j;h.doc=E;y.doc=D;f.doc=B;b.doc=R;v.doc=F;w.doc=A;C.doc=z;x.doc=q;S.doc=T;V.doc=$;function M(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="slider-hua-dong-qi">Slider 滑动器<a class="doc-anchor" href="#slider-hua-dong-qi">#</a></h1>
