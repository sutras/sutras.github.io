import{j as f,a as n,F as t,R as s}from"./index-b9ddf759.js";import{I as E,B as w,D as a}from"./index-cef2ca44.js";import{c as x}from"./index-2e4736b8.js";import"./index.es-5a450476.js";const p=r=>{const{className:d,children:o,icon:m,iconProps:y,description:c="暂无数据",...h}=r,g=x("s-empty",d);return f("div",{...h,className:g,children:[n("div",{className:"s-empty-icon",children:m??n(E,{prefix:"si",name:"empty",...y})}),c&&n("div",{className:"s-empty-description",children:c}),o&&n("div",{className:"s-empty-extra",children:o})]})};function e(){return n(t,{children:n(p,{})})}const v={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function l(){return n(t,{children:n(p,{description:"自定义描述内容"})})}const F={doc:`<h3>自定义描述信息</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Empty <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function u(){return n(t,{children:n(p,{iconProps:{size:40}})})}const B={doc:`<h3>自定义图标大小</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Empty <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function k(){return n(t,{children:n(p,{iconProps:{name:new URL("/sard/assets/empty-a8ca74c8.svg",self.location).href}})})}const D={doc:`<h3>图片类型图标</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Empty <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function i(){return n(t,{children:n(p,{children:n(w,{children:"重新请求"})})})}const N={doc:`<h3>额外内容</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};e.doc=v;l.doc=F;u.doc=B;k.doc=D;i.doc=N;function R(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="empty-kong-zhuang-tai">Empty 空状态<a class="doc-anchor" href="#empty-kong-zhuang-tai">#</a></h1>
