import{a as n,C as u,f as d,j as c,P as t,h as k,F as w,R as e}from"./index-b8e75f22.js";import{D as l}from"./Demo-3b19c6f8.js";import"./index.es-833d515d.js";function g(){return n(u,{onChange:a=>{d.show(a.toLocaleDateString())}})}const E={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function m(){return c(t,{title:"请选择日期",children:[n(t.Outlet,{children:({value:s,setValue:a,setVisible:p})=>n(k,{readOnly:!0,placeholder:"请选择日期",value:(s==null?void 0:s.toLocaleDateString())||"",clearable:!0,onClear:()=>a(),onClick:()=>p(!0)})}),n(t.Target,{children:n(u,{})})]})}const x={doc:`<h3>配合弹出框使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function v(){const s=a=>/0|6/.test(String(a.getDay()));return c(t,{title:"请选择日期",children:[n(t.Outlet,{children:({value:a,setValue:p,setVisible:o})=>n(k,{readOnly:!0,placeholder:"请选择日期",value:(a==null?void 0:a.toLocaleDateString())||"",clearable:!0,onClear:()=>p(),onClick:()=>o(!0)})}),n(t.Target,{children:n(u,{disabledDate:s})})]})}const A={doc:`<h3>禁用日期</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Popout<span class="token punctuation">,</span> Calendar<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function C(){return c(t,{title:"请选择日期",style:{"--s-primary":"var(--s-danger)","--s-calendar-day-selected-bg":"var(--s-danger)"},children:[n(t.Outlet,{children:({value:s,setValue:a,setVisible:p})=>n(k,{readOnly:!0,placeholder:"请选择日期",value:(s==null?void 0:s.map(o=>o.toLocaleDateString()).join("-"))||"",clearable:!0,onClear:()=>a(),onClick:()=>p(!0)})}),n(t.Target,{children:n(u,{type:"range"})})]})}const V={doc:`<h3>自定义颜色</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Popout<span class="token punctuation">,</span> Calendar<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function D(){return c(t,{title:"请选择日期",children:[n(t.Outlet,{children:({value:s,setValue:a,setVisible:p})=>n(k,{readOnly:!0,placeholder:"请选择日期",value:(s==null?void 0:s.toLocaleDateString())||"",clearable:!0,onClear:()=>a(),onClick:()=>p(!0)})}),n(t.Target,{children:n(u,{weekStartsOn:1})})]})}const T={doc:`<h3>自定义起始周</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Popout<span class="token punctuation">,</span> Calendar<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};g.doc=E;m.doc=x;y.doc=P;h.doc=j;f.doc=O;b.doc=B;v.doc=A;C.doc=V;D.doc=T;F.doc=I;function z(){return e.createElement("div",{className:"doc-content"},e.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="calendar-ri-li">Calendar 日历<a class="doc-anchor" href="#calendar-ri-li">#</a></h1>
...
`}}),e.createElement("section",{className:"doc-section"},e.createElement(l,null,g),e.createElement(l,null,m),e.createElement(l,null,y),e.createElement(l,null,h),e.createElement(l,null,f),e.createElement(l,null,b),e.createElement(l,null,v),e.createElement(l,null,C),e.createElement(l,null,D),e.createElement(l,null,F)),e.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h2 id="api">API<a class="doc-anchor" href="#api">#</a></h2>
...
</div><div class="doc-card"><h3 id="calendarref">CalendarRef<a class="doc-anchor" href="#calendarref">#</a></h3>
<div class="doc-table-responsive"><table>
<thead>
<tr>
<th>属性</th>
