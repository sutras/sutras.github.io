import{j as p,a,F as o,R as n}from"./index-b9ddf759.js";import{I as C,D as t}from"./index-cef2ca44.js";import{c as D}from"./index-2e4736b8.js";import"./index.es-5a450476.js";const s=g=>{const{className:m,children:y,theme:h="default",plain:f,round:x,mark:w,size:v="medium",closable:T,onClose:E,...b}=g,B=D("s-tag",`s-tag-${h}`,`s-tag-${v}`,{"s-tag-plain":f,"s-tag-round":x,"s-tag-mark":w},m);return p("div",{...b,className:B,children:[y,T&&a(C,{className:"s-tag-close",prefix:"si",name:"close",onClick:E})]})};function e(){return a(o,{children:a(s,{children:"标签"})})}const q={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};e.doc=q;c.doc=F;l.doc=j;u.doc=z;k.doc=$;i.doc=A;r.doc=N;d.doc=W;function P(){return n.createElement("div",{className:"doc-content"},n.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="tag-biao-qian">Tag 标签<a class="doc-anchor" href="#tag-biao-qian">#</a></h1>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-tag-line-height</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-leading-xs<span class="token punctuation">)</span><span class="token punctuation">;</span>
