import{r as e,j as i,F as r,a as n,R as a}from"./index-b9ddf759.js";import{B as k,Y as C,e as c,Z as m,D as l}from"./index-cef2ca44.js";import"./index-2e4736b8.js";import"./index.es-5a450476.js";const d=300,y={transition:`opacity ${d}ms ease-in-out`,opacity:0},h={entering:{opacity:1},entered:{opacity:1},exiting:{opacity:0},exited:{opacity:0}};function F(){const[p,o]=e.useState(!0);return i(r,{children:[n(k,{onClick:()=>{o(s=>!s)},children:"Toggle"}),n(C,{in:p,timeout:d,children:s=>n("div",{"data-status":s,style:{...y,...h[s]},children:"这是一个淡入淡出的过渡"})})]})}const B={doc:`<h3>Transition</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function E(){const[p,o]=e.useState(!0),[u,s]=e.useState("fade"),g=()=>{o(t=>!t)};return i(r,{children:[n(c.Group,{value:u,onChange:s,vertical:!0,children:["fade","slide-top","slide-right","slide-bottom","slide-left","zoom","collapse"].map(t=>n(c,{value:t,children:t},t))}),n("br",{}),n(k,{onClick:g,children:"Toggle Visible"}),n(m,{in:p,type:u,timeout:300,children:n("section",{style:{width:100,height:100,margin:100,background:"orange"}})})]})}const D={doc:`<h3>CSSTransition</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};F.doc=B;E.doc=D;function A(){return a.createElement("div",{className:"doc-content"},a.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="transition-guo-du">Transition 过渡<a class="doc-anchor" href="#transition-guo-du">#</a></h1>
