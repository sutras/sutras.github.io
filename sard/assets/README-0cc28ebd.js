import{r as p,j as c,F as o,a as s,B as l,I as f,h as r,R as t}from"./index-ba304632.js";import{D as e}from"./Demo-5a7b5c0e.js";import{N as u}from"./index-43bbb170.js";import"./index.es-526e18cf.js";function d(){const[a,n]=p.useState(!1);return c(o,{children:[s(l,{onClick:()=>n(!0),children:"弹出键盘"}),s(u,{visible:a,onVisible:n})]})}const E={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function m(){const[a,n]=p.useState(!1);return c(o,{children:[s(l,{onClick:()=>n(!0),children:"弹出键盘"}),s(u,{title:c(o,{children:[s(f,{name:"bi-shield-lock-fill"}),s("span",{style:{marginLeft:5,verticalAlign:"middle"},children:"安全键盘"})]}),visible:a,onVisible:n})]})}const B={doc:`<h3>标题</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function v(){const[a,n]=p.useState(!1),[i,k]=p.useState("");return c(o,{children:[s(r,{readOnly:!0,placeholder:"请输入验证码",value:i,clearable:!0,onClear:k,onClick:()=>n(!0)}),s(u,{value:i,onChange:k,maxLength:6,visible:a,onVisible:n})]})}const C={doc:`<h3>双向绑定</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function h(){const[a,n]=p.useState("");return s(o,{children:s(u,{value:a,onChange:n,maxLength:6,children:s(r,{readOnly:!0,placeholder:"请输入验证码",value:a,clearable:!0,onClear:n})})})}const F={doc:`<h3>简化键盘弹出</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> NumberKeyboard<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};d.doc=E;g.doc=w;b.doc=x;m.doc=B;y.doc=D;v.doc=C;h.doc=F;function S(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="numberkeyboard-shu-zi-jian-pan">NumberKeyboard 数字键盘<a class="doc-anchor" href="#numberkeyboard-shu-zi-jian-pan">#</a></h1>
...
`}}),t.createElement("section",{className:"doc-section"},t.createElement(e,null,d),t.createElement(e,null,g),t.createElement(e,null,b),t.createElement(e,null,m),t.createElement(e,null,y),t.createElement(e,null,v),t.createElement(e,null,h)),t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h2 id="api">API<a class="doc-anchor" href="#api">#</a></h2>
