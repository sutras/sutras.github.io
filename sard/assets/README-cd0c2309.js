import{a as n,j as l,F as h,r as b,R as c}from"./index-b9ddf759.js";import{L as _,f as E,p as $,B as S,D as f}from"./index-cef2ca44.js";import{c as A}from"./index-2e4736b8.js";import"./index.es-5a450476.js";const H=p=>{const{className:s,style:u,children:r,title:a,label:t,color:g,loading:i,loadingProps:w,disabled:y,onClick:d,...v}=p,o=x=>{!y&&!i&&(d==null||d(x))},k=A("s-action-sheet-item",{"s-action-sheet-item-disabled":y,"s-action-sheet-item-loading":i},s),F={color:g,...u};return n("button",{...v,type:"button",className:k,style:F,onClick:o,disabled:y,children:i?n(_,{...w}):l(h,{children:[a&&n("div",{className:"s-action-sheet-item-title",children:a}),t&&n("div",{className:"s-action-sheet-item-label",children:t})]})})},C=p=>{const{className:s,children:u,visible:r,maskClosable:a=!0,actionClosable:t,title:g,description:i,itemList:w=[],cancel:y,onSelect:d,onCancel:v,onClose:o,popupProps:k={},...F}=p,{placement:x="bottom",...V}=k,P=E((e,m)=>{d==null||d(e,m),t&&(o==null||o(!1))}),R=E(e=>{var m;a&&((m=k==null?void 0:k.onMaskClick)==null||m.call(k,e),o==null||o(!1))}),z=E(()=>{v==null||v(!1),o==null||o(!1)}),M=A("s-action-sheet",{"s-action-sheet-headless":!g&&!i},s);return n($,{...V,visible:r,placement:x,onMaskClick:R,children:l("div",{...F,className:M,children:[(g||i)&&l("div",{className:"s-action-sheet-header",children:[g&&n("div",{className:"s-action-sheet-title",children:g}),i&&n("div",{className:"s-action-sheet-description",children:i})]}),n("div",{className:"s-action-sheet-body",children:u||w.map((e,m)=>b.createElement(H,{...e,key:m,onClick:q=>{var B;P(e,m),(B=e.onClick)==null||B.call(e,q)}}))}),y&&l(h,{children:[n("div",{className:"s-action-sheet-gap"}),n("button",{className:"s-action-sheet-cancel",onClick:z,children:y})]})]})})};function j(){const[p,s]=b.useState(!1);return l(h,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{visible:p,itemList:[{title:"动作1"},{title:"动作2"},{title:"动作3"}],actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const T={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function L(){const[p,s]=b.useState(!1);return l(h,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{visible:p,itemList:[{title:"动作1"},{title:"动作2"},{title:"动作3"}],cancel:"取消",actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const G={doc:`<h3>取消按钮</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> ActionSheet<span class="token punctuation">,</span> ActionSheetItemProps<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function D(){const[p,s]=b.useState(!1);return l(h,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{visible:p,itemList:[{title:"动作1"},{title:"动作2",label:"这是一个描述"},{title:"动作3"}],cancel:"取消",actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const J={doc:`<h3>描述信息</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> ActionSheet<span class="token punctuation">,</span> ActionSheetItemProps<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function N(){const[p,s]=b.useState(!1);return l(h,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{visible:p,itemList:[{title:"动作1",color:"red"},{title:"动作2",disabled:!0},{title:"动作3",loading:!0}],cancel:"取消",actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const K={doc:`<h3>状态</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> ActionSheet<span class="token punctuation">,</span> ActionSheetItemProps<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function I(){const[p,s]=b.useState(!1);return l(h,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{title:"这是标题",description:"这是描述",visible:p,itemList:[{title:"动作1"},{title:"动作2"},{title:"动作3"}],actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const O={doc:`<h3>标题&amp;描述</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> ActionSheet<span class="token punctuation">,</span> ActionSheetItemProps<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
