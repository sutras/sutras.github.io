import{S as H,p as L,c as k,a as n,F as c,j as f,x as O,Z,r as G,I as g,R as p}from"./index-be529937.js";import{D as u}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";const l=o=>{const[i]=H("pagination"),{className:x,total:B=0,pageSize:F=10,current:X,defaultCurrent:Y,pageCount:A,pageItemCount:P=5,hideOnSinglePage:S=!1,type:m="multi",ellipsis:j,prev:z,next:N,page:h,onChange:nn,...D}=o,e=(A??Math.ceil(B/F))||1,[a,I]=L(o,{defaultValuePropName:"defaultCurrent",valuePropName:"current",initialValue:1,postValue:s=>O(s,1,e)}),[y,R]=Z(a,e,P),_=()=>{a>1&&r(a-1)},q=()=>{a<e&&r(a+1)},M=s=>{r(s)},r=s=>{s!==a&&I(s)},T=()=>{const s=R-y+1;return Array(s).fill(0).map((an,d)=>{const t=d+y;return n("div",{"data-page":t,className:k("s-pagination-item",{"s-pagination-item-current":a===t}),onClick:()=>M(t),children:j&&(d===0&&t!==1||d===s-1&&t!==e)?"...":h?h(t,a===t):t},t)})},V=()=>f("div",{className:"s-pagination-ratio",children:[a,"/",e]}),$=k("s-pagination","s-pagination-"+m,x);return n(c,{children:(!S||e>1)&&f("div",{...D,className:$,children:[n("div",{className:k("s-pagination-item s-pagination-prev",{"s-pagination-item-disabled":a===1}),onClick:_,children:z??i("previous")}),m==="simple"?V():T(),n("div",{className:k("s-pagination-item s-pagination-next",{"s-pagination-item-disabled":a===e}),onClick:q,children:N??i("next")})]})})};function v(){return n(c,{children:n(l,{total:100,pageSize:10})})}const J={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function b(){const[o,i]=G.useState(1);return n(c,{children:n(l,{total:100,pageSize:10,current:o,onChange:i})})}const K={doc:`<h3>受控的</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Pagination <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function E(){return n(c,{children:n(l,{total:100,pageSize:10,ellipsis:!0})})}const Q={doc:`<h3>显示省略号</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Pagination <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function C(){return n(c,{children:n(l,{total:43,pageSize:10,type:"simple"})})}const U={doc:`<h3>简单分页</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Pagination <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function w(){return n(c,{children:n(l,{total:100,pageSize:10,prev:n(g,{name:"bi-chevron-double-left"}),next:n(g,{name:"bi-chevron-double-right"}),page:o=>o===2?n(g,{name:"bi-cup-hot"}):o})})}const W={doc:`<h3>自定义</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};v.doc=J;b.doc=K;E.doc=Q;C.doc=U;w.doc=W;function on(){return p.createElement("div",{className:"doc-content"},p.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="pagination-fen-ye">Pagination 分页<a class="doc-anchor" href="#pagination-fen-ye">#</a></h1>
