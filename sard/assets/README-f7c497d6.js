import{p as h,c as w,j as v,a as s,r as u,F as l,R as t}from"./index-ba304632.js";import{D as c}from"./Demo-5a7b5c0e.js";import{N as T}from"./index-43bbb170.js";import"./index.es-526e18cf.js";const r=n=>{const{className:a,style:E,children:R,value:q,defaultValue:H,onChange:G,length:i=6,type:B="border",gap:d,plainText:b,focused:J,defaultFocused:O,onFocused:Q,onClick:k,native:D,...V}=n,[o,I]=h(n,{defaultValue:""}),[g,m]=h(n,{defaultValuePropName:"defaultFocused",valuePropName:"focused",trigger:"onFocused",defaultValue:!1}),P=e=>{k==null||k(e)},S=e=>{I((e.target.value??e.detail.value).slice(0,i))},j=()=>{m(!0)},N=()=>{m(!1)},A=w("s-password-input",`s-password-input-${B}`,{"s-password-input-gapless":d===0},a),z={...E,gap:d};return v("div",{...V,className:A,onClick:P,style:z,children:[Array(i).fill(0).map((e,p)=>v("div",{className:w("s-password-input-item",{"s-password-input-item-active":g&&(p===o.length||p===o.length-1&&p===i-1)}),children:[p<o.length&&(b?s("div",{className:"s-password-input-plaintext",children:o[p]}):s("div",{className:"s-password-input-ciphertext"})),g&&p===o.length&&s("div",{className:"s-password-input-cursor"})]},p)),D&&s("input",{className:"s-password-input-input",value:o,onChange:S,onFocus:j,onBlur:N})]})};function y(){const[n,a]=u.useState("");return s(l,{children:s(T,{onChange:a,maxLength:6,focusedProp:"focused",children:s(r,{value:n})})})}const _={doc:`<h3>结合数字键盘使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};y.doc=_;f.doc=$;F.doc=K;C.doc=L;x.doc=M;function Z(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="passwordinput-mi-ma-shu-ru-kuang">PasswordInput 密码输入框<a class="doc-anchor" href="#passwordinput-mi-ma-shu-ru-kuang">#</a></h1>
