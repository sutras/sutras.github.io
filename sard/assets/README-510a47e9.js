import{j as t,a0 as a,a as n,r as e,I as m,F as g,m as b,R as s}from"./index-ba304632.js";import{D as o}from"./Demo-5a7b5c0e.js";import"./index.es-526e18cf.js";function l(){return t(a,{defaultActiveKey:0,fixed:!1,children:[n(a.Item,{icon:{name:"bi-house-door-fill"},children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})}const h={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function i(){return t(a,{defaultActiveKey:0,fixed:!1,children:[n(a.Item,{icon:p=>n(m,{name:p?"bi-house-door-fill":"bi-house-door"}),children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})}const f={doc:`<h3>自定义图标</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function r(){const[p,c]=e.useState(!1);return t(g,{children:[n(b,{defaultChecked:p,onChange:c,style:{marginBottom:20},children:"固定定位"}),t(a,{defaultActiveKey:0,fixed:p,children:[n(a.Item,{icon:{name:"bi-house-door-fill"},children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})]})}const v={doc:`<h3>固定定位</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};l.doc=h;u.doc=y;i.doc=f;k.doc=x;r.doc=v;d.doc=I;function E(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="tabbar-biao-qian-lan">Tabbar 标签栏<a class="doc-anchor" href="#tabbar-biao-qian-lan">#</a></h1>
