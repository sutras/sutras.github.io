import{j as t,a as n,r as e,F as m,R as s}from"./index-093297df.js";import{J as a,I as g,d as b,D as o}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import"./index.es-471f4c94.js";function l(){return t(a,{defaultActiveKey:0,fixed:!1,children:[n(a.Item,{icon:{name:"bi-house-door-fill"},children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})}const h={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function k(){return t(a,{defaultActiveKey:0,fixed:!1,color:"rebeccapurple",activeColor:"orange",children:[n(a.Item,{icon:{name:"bi-house-door-fill"},children:"首页"}),n(a.Item,{icon:{name:"bi-cart-fill"},children:"购物车"}),n(a.Item,{icon:{name:"bi-chat-dots-fill"},children:"消息"}),n(a.Item,{icon:{name:"bi-person-circle"},children:"我的"})]})}const v={doc:`<h3>自定义颜色</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tabbar <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token string">'bootstrap-icons/font/bootstrap-icons.css'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">return</span> <span class="token punctuation">(</span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Tabbar</span></span>
      ...
      <span class="token attr-name">color</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>rebeccapurple<span class="token punctuation">"</span></span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};l.doc=h;u.doc=y;i.doc=f;k.doc=v;r.doc=x;d.doc=I;function C(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="tabbar-biao-qian-lan">Tabbar 标签栏<a class="doc-anchor" href="#tabbar-biao-qian-lan">#</a></h1>
