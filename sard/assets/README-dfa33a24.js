import{r as c,j as t,F as e,a as s,B as l,a9 as u,R as a}from"./index-be529937.js";import{D as i}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function p(){const[n,o]=c.useState(!0);return t(e,{children:[s(l,{onClick:()=>{o(!n)},children:"toggle"}),s("br",{}),s("br",{}),s(u,{visible:n,children:t("div",{style:{backgroundColor:"var(--s-secondary-bg)",padding:10},children:[s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"})]})})]})}const k={doc:`<h3>基础使用</h3>
