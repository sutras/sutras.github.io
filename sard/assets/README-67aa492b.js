import{j as e,a as s,r as P,F as o,R as n}from"./index-b9ddf759.js";import{D as c}from"./index-cef2ca44.js";import{c as B}from"./index-2e4736b8.js";import{S as D}from"./index-d306ff27.js";import"./index.es-5a450476.js";const b=(a,t)=>{const p=Math.PI*2*t;return a/100*p+" "+p};function u(a){const{className:t,style:p,children:h,percent:y=0,color:f,trackColor:C,size:i,thickness:l=4,...F}=a,r=50-l/2,E=B("s-progress-circle",t),v={width:i,height:i,...p},w={stroke:C,strokeWidth:l,r},x={stroke:f,strokeDasharray:b(y,r),strokeWidth:l,r};return e("div",{...F,className:E,style:v,children:[e("svg",{viewBox:"0 0 100 100",className:"s-progress-circle-graph",children:[s("circle",{cx:"50",cy:"50",fill:"none",className:"s-progress-circle-track",style:w}),s("circle",{cx:"50",cy:"50",fill:"none",className:"s-progress-circle-trail",style:x})]}),h]})}function k(){const[a,t]=P.useState(50);return e(o,{children:[s(D,{value:a,max:100,min:0,onChange:t,style:{marginBottom:10}}),e(u,{percent:a,children:[a,"%"]})]})}const j={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};k.doc=j;d.doc=A;g.doc=S;m.doc=N;function M(){return n.createElement("div",{className:"doc-content"},n.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="progresscircle-huan-xing-jin-du-tiao">ProgressCircle 环形进度条<a class="doc-anchor" href="#progresscircle-huan-xing-jin-du-tiao">#</a></h1>
