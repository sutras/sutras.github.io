import{r as l,j as e,F as u,a as n,B as s,a5 as t,R as p}from"./index-be529937.js";import{D as c}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function k(){const[o,a]=l.useState(!1);return e(u,{children:[n(s,{onClick:()=>a(!0),children:"显示通知"})," ",n(s,{onClick:()=>a(!1),children:"隐藏通知"}),n(t,{visible:o,message:"这是一条通知",onTimeout:a})]})}const C={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function d(){const[o,a]=l.useState(!1);return e(u,{children:[n(s,{onClick:()=>a(!0),children:"显示通知"})," ",n(s,{onClick:()=>a(!1),children:"隐藏通知"}),n(t,{visible:o,color:"orange",background:"fuchsia",message:"这是一条通知",onTimeout:a})]})}const B={doc:`<h3>自定义颜色</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> Notify<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
