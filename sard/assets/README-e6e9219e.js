import{a,r as e,j as c,F as l,R as s}from"./index-093297df.js";import{d as n,I as x,D as p}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import"./index.es-471f4c94.js";function u(){return a(n,{children:"复选框"})}const b={doc:`<h3>基础用法</h3>
...
<span class="token punctuation">}</span>`};function k(){const[t,o]=e.useState(!1);return a(n,{checked:t,onChange:o,children:t?"已选中":"未选中"})}const y={doc:`<h3>受控</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Checkbox <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token punctuation">}</span>`};function i(){return c(l,{children:[a(n,{disabled:!0,checked:!0,style:{marginRight:10},children:"复选框"}),a(n,{disabled:!0,children:"复选框"})]})}const C={doc:`<h3>禁用状态</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Checkbox <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function r(){const[t,o]=e.useState(["apple"]);return c(l,{children:[c("div",{children:[c(n.Group,{value:t,onChange:o,children:[a(n,{value:"apple",children:"苹果"}),a(n,{value:"banana",children:"香蕉"})]}),JSON.stringify(t)]}),c("div",{style:{marginTop:20},children:[a("div",{children:"垂直："}),c(n.Group,{vertical:!0,value:t,onChange:o,children:[a(n,{value:"apple",children:"苹果"}),a(n,{value:"banana",children:"香蕉"})]})]})]})}const v={doc:`<h3>复选框组</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function d(){return a(n,{size:"2em",children:"复选框"})}const f={doc:`<h3>图标大小</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Checkbox <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};u.doc=b;k.doc=y;i.doc=C;r.doc=v;d.doc=f;h.doc=w;g.doc=E;m.doc=F;function S(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="checkbox-fu-xuan-kuang">Checkbox 复选框<a class="doc-anchor" href="#checkbox-fu-xuan-kuang">#</a></h1>
