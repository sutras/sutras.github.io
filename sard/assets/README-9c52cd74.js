import{a as s,F as u,r as E,j as k,R as o}from"./index-b9ddf759.js";import{q as l,B as $,P as r,b as x,D as e}from"./index-cef2ca44.js";import"./index-2e4736b8.js";import"./index.es-5a450476.js";function g(){const t=Array(1).fill(0).map((p,a)=>Array(60).fill(0).map((c,n)=>({value:`${a}-${n}`,label:`column${a}-item${n}`})));return s(u,{children:s(l,{columns:t})})}const w={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function f(){const t=Array(2).fill(0).map((p,a)=>Array(10).fill(0).map((c,n)=>({value:`${a}-${n}`,label:`column${a}-item${n}`})));return s(u,{children:s(l,{columns:t})})}const A={doc:`<h3>多列</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function y(){const t=Array(2).fill(0).map((i,d)=>Array(10).fill(0).map((B,m)=>({value:`${d}-${m}`,label:`column${d}-item${m}`}))),[p,a]=E.useState(["0-19","1-3"]),c=["0-7","1-0"],n=i=>{a(i)};return k(u,{children:[k($,{onClick:()=>a(c),children:["change to: ",JSON.stringify(c)]}),k("p",{children:["current value: ",JSON.stringify(p)]}),s(l,{columns:t,value:p,onChange:n})]})}const F={doc:`<h3>受控的</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function h(){const t=Array(2).fill(0).map((p,a)=>Array(10).fill(0).map((c,n)=>({value:`${a}-${n}`,label:`column${a}-item${n}${n%2===0?"-disabled":""}`,disabled:n%2===0})));return s(u,{children:s(l,{columns:t,defaultValue:["0-1","1-3"]})})}const C={doc:`<h3>禁用选项</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function b(){const t=Array(2).fill(0).map((p,a)=>Array(10).fill(0).map((c,n)=>({id:`${a}-${n}`,text:`column${a}-item${n}`})));return s(u,{children:s(l,{columns:t,fieldNames:{value:"id",label:"text"}})})}const D={doc:`<h3>自定义字段名</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function v(){const t=Array(1).fill(0).map((p,a)=>Array(10).fill(0).map((c,n)=>({value:`${a}-${n}`,label:`column${a}-item${n}`})));return s(u,{children:k(r,{title:"请选择",children:[s(r.Outlet,{children:({value:p,setValue:a,triggerArgs:[,c=[]],setVisible:n})=>s(x,{value:(p==null?void 0:p.length)&&c.map(i=>i.name).join("/")||"",onClear:()=>a(),onClick:()=>n(!0),clearable:!0,readOnly:!0,placeholder:"请选择"})}),s(r.Target,{children:s(l,{columns:t})})]})})}const j={doc:`<h3>配合弹出框使用</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker<span class="token punctuation">,</span> PickerOption<span class="token punctuation">,</span> Popout<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};g.doc=w;f.doc=A;y.doc=F;h.doc=C;b.doc=D;v.doc=j;function N(){return o.createElement("div",{className:"doc-content"},o.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="picker-xuan-ze-qi">Picker 选择器<a class="doc-anchor" href="#picker-xuan-ze-qi">#</a></h1>
...
`}}),o.createElement("section",{className:"doc-section"},o.createElement(e,null,g),o.createElement(e,null,f),o.createElement(e,null,y),o.createElement(e,null,h),o.createElement(e,null,b),o.createElement(e,null,v)),o.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h2 id="api">API<a class="doc-anchor" href="#api">#</a></h2>
