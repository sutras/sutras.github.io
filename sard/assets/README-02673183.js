import{j as p,a,F as e,R as n}from"./index-093297df.js";import{I as C,D as t}from"./index-c0b255c8.js";import{c as D}from"./index-2e4736b8.js";import"./index.es-471f4c94.js";const s=g=>{const{className:m,children:y,theme:h="default",plain:f,round:x,mark:w,size:T="medium",closable:v,onClose:E,...B}=g,b=D("s-tag",`s-tag-${h}`,`s-tag-${T}`,{"s-tag-plain":f,"s-tag-round":x,"s-tag-mark":w},m);return p("div",{...B,className:b,children:[y,v&&a(C,{className:"s-tag-close",prefix:"si",name:"close",onClick:E})]})};function o(){return a(e,{children:a(s,{children:"标签"})})}const q={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function c(){return p("div",{style:{display:"flex",flexWrap:"wrap",gap:10},children:[a(s,{theme:"primary",children:"primary"}),a(s,{theme:"secondary",children:"secondary"}),a(s,{theme:"success",children:"success"}),a(s,{theme:"info",children:"info"}),a(s,{theme:"warning",children:"warning"}),a(s,{theme:"danger",children:"danger"})]})}const j={doc:`<h3>主题色</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tag <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function l(){return p("div",{style:{display:"flex",flexWrap:"wrap",gap:10},children:[a(s,{plain:!0,theme:"primary",children:"primary"}),a(s,{plain:!0,theme:"secondary",children:"secondary"}),a(s,{plain:!0,theme:"success",children:"success"}),a(s,{plain:!0,theme:"info",children:"info"}),a(s,{plain:!0,theme:"warning",children:"warning"}),a(s,{plain:!0,theme:"danger",children:"danger"})]})}const F={doc:`<h3>镂空</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tag <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function u(){return a(e,{children:a(s,{round:!0,children:"标签"})})}const z={doc:`<h3>圆角</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tag <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function k(){return a(e,{children:a(s,{mark:!0,children:"标签"})})}const $={doc:`<h3>标记样式（半圆角）</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tag <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function d(){return a(e,{children:a(s,{closable:!0,onClose:()=>console.log("close"),children:"标签"})})}const W={doc:`<h3>可关闭的</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tag <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};o.doc=q;c.doc=j;l.doc=F;u.doc=z;k.doc=$;i.doc=A;r.doc=N;d.doc=W;function P(){return n.createElement("div",{className:"doc-content"},n.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="tag-biao-qian">Tag 标签<a class="doc-anchor" href="#tag-biao-qian">#</a></h1>
...
`}}),n.createElement("section",{className:"doc-section"},n.createElement(t,null,o),n.createElement(t,null,c),n.createElement(t,null,l),n.createElement(t,null,u),n.createElement(t,null,k),n.createElement(t,null,i),n.createElement(t,null,r),n.createElement(t,null,d)),n.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h2 id="api">API<a class="doc-anchor" href="#api">#</a></h2>
