import{a,F as c,j as s,k as t,a1 as n,r as S,B as C,I as k,M as B,R as p}from"./index-ba304632.js";import{D as e}from"./Demo-5a7b5c0e.js";import"./index.es-526e18cf.js";function i(){return a(c,{children:s(t,{children:[a(n,{label:"标签1",children:"内容1"}),a(n,{label:"标签2",children:"内容2"}),a(n,{label:"标签3",children:"内容3"})]})})}const D={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function q(){return a(c,{children:a(t,{scrollspy:!0,offset:108,sticky:!0,headerStyle:{top:60,background:"var(--s-emphasis-bg)"},children:Array(7).fill(0).map((l,o)=>s(n,{label:`标签${o+1}`,style:{border:"1px solid #ddd",margin:5,padding:50},children:["内容",o+1]},o))})})}const O={doc:`<h3>滚动监听</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tabs<span class="token punctuation">,</span> TabPane <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function F(){return a(c,{children:a(t,{vertical:!0,scrollspy:!0,offset:55,sticky:!0,headerStyle:{top:55},type:"card",style:{padding:10,background:"var(--s-secondary-bg)"},bodyStyle:{background:"var(--s-emphasis-bg)"},children:Array(7).fill(0).map((l,o)=>s(n,{label:`标签${o+1}`,style:{border:"1px solid #ddd",margin:5,padding:50},children:["内容",o+1]},o))})})}const J={doc:`<h3>垂直滚动监听</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tabs<span class="token punctuation">,</span> TabPane <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
