import{a as s,F as u,j as t,X as n,r as k,B as d,h as y,R as p}from"./index-ba304632.js";import{D as l}from"./Demo-5a7b5c0e.js";import{S as m}from"./index-1a8643c1.js";import"./index.es-526e18cf.js";function g(){return s(u,{children:t(n,{className:"demo-swiper",showDots:!0,children:[s(n.Item,{className:"demo-swiper-item",children:"item1"}),s(n.Item,{className:"demo-swiper-item",children:"item2"}),s(n.Item,{className:"demo-swiper-item",children:"item3"})]})})}const E={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function w(){const e=k.useRef(null),r=()=>{var a;(a=e.current)==null||a.prev()},c=()=>{var a;(a=e.current)==null||a.next()},[i,o]=k.useState(0);return t(u,{children:[t("div",{style:{marginBottom:5},children:[s(d,{onClick:r,children:"prev"})," ",s(d,{onClick:c,children:"next"})," ",s(y,{style:{display:"inline-flex",verticalAlign:"middle",width:70},type:"number",value:i,onChange:a=>o(+a)})," ",s(d,{onClick:()=>{var a;(a=e.current)==null||a.swipeTo(i||0)},children:"swipeTo"})]}),t(n,{ref:e,showDots:!0,className:"demo-swiper",onChange:a=>{o(a)},children:[s(n.Item,{className:"demo-swiper-item",children:"item1"}),s(n.Item,{className:"demo-swiper-item",children:"item2"}),s(n.Item,{className:"demo-swiper-item",children:"item3"})]})]})}const S={doc:`<h3>命令</h3>
