import{r as l,j as p,F as k,a as n,B as v,P as t,f as g,h as m,C as d,S as r,D as P,J as w,R as c}from"./index-ba304632.js";import{D as u}from"./Demo-5a7b5c0e.js";import{C as D,a as A}from"./area-a5fea70b.js";import"./index.es-526e18cf.js";function C(){const[a,s]=l.useState(!1);return p(k,{children:[n(v,{onClick:()=>s(!0),children:"显示弹出框"}),p(t,{visible:a,title:"标题",onClose:s,onConfirm:()=>g.show("确定"),onCancel:()=>g.show("取消"),children:[n("div",{children:"弹出框内容"}),n("div",{children:"弹出框内容"}),n("div",{children:"弹出框内容"})]})]})}const B={doc:`<h3>基础使用</h3>
...
}</span>`};function y(){return n(k,{children:p(t,{title:"请选择出生日期",children:[n(t.Outlet,{children:({value:a,setValue:s,setVisible:o})=>n(m,{readOnly:!0,placeholder:"请选择日期",value:(a==null?void 0:a.toLocaleDateString())||"",clearable:!0,onClear:()=>s(null),onClick:()=>o(!0)})}),n(t.Target,{children:n(d,{})})]})})}const O={doc:`<h3>简化操作</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function b(){const[a,s]=l.useState(new Date);return n(k,{children:p(t,{title:"请选择出生日期",value:a,onChange:e=>{s(e)},children:[n(t.Outlet,{children:({value:e,setValue:h,setVisible:i})=>n(m,{readOnly:!0,placeholder:"请选择日期",value:(e==null?void 0:e.toLocaleDateString())||"",clearable:!0,onClear:()=>h(null),onClick:()=>i(!0)})}),n(t.Target,{children:n(d,{})})]})})}const S={doc:`<h3>受控的弹出框</h3>
...
}</span>`};function x(){return n(k,{children:p(t,{title:"请选择出生日期",fast:!0,showConfirm:!1,children:[n(t.Outlet,{children:({value:a,setValue:s,setVisible:o})=>n(m,{readOnly:!0,placeholder:"请选择日期",value:(a==null?void 0:a.toLocaleDateString())||"",clearable:!0,onClear:()=>s(null),onClick:()=>o(!0)})}),n(t.Target,{children:n(d,{})})]})})}const T={doc:`<h3>快捷确认</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};C.doc=B;E.doc=j;f.doc=V;y.doc=O;b.doc=S;x.doc=T;F.doc=L;function $(){return c.createElement("div",{className:"doc-content"},c.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="popout-tan-chu-kuang">Popout 弹出框<a class="doc-anchor" href="#popout-tan-chu-kuang">#</a></h1>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-popout-footer-gap-y</span><span class="token punctuation">:</span> 16px<span class="token punctuation">;</span>
