import{r as u,j as l,F as c,a as n,R as t}from"./index-093297df.js";import{B as s,T as a,I as y,D as o}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import"./index.es-471f4c94.js";function i(){const[g,e]=u.useState(!1),[h,m]=u.useState("text"),[f,C]=u.useState(""),p=(E,T)=>{m(E),C(T),e(!0)},F=()=>{e(!1)},B=()=>{e(!1)};return l(c,{children:[n(s,{onClick:()=>p("text","文本提示"),children:"文本提示"})," ",n(s,{onClick:()=>p("success","成功"),children:"成功提示"})," ",n(s,{onClick:()=>p("fail","失败"),children:"失败提示"})," ",n(s,{onClick:()=>p("loading","加载中"),children:"加载中提示"})," ",n(s,{onClick:()=>B(),children:"隐藏提示"}),n(a,{visible:g,type:h,title:f,onTimeout:F})]})}const v={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function r(){return n(c,{children:n(s,{onClick:()=>a.show("休息一下",{icon:n(y,{name:"bi-cup-hot"})}),children:"显示提示框"})})}const x={doc:`<h3>自定义图标</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};i.doc=v;k.doc=w;r.doc=x;d.doc=b;function P(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="toast-qing-ti-shi">Toast 轻提示<a class="doc-anchor" href="#toast-qing-ti-shi">#</a></h1>
