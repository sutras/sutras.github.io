import{r as u,j as l,F as c,a as n,R as t}from"./index-b9ddf759.js";import{B as s,r as a,I as E,D as o}from"./index-cef2ca44.js";import"./index-2e4736b8.js";import"./index.es-5a450476.js";function i(){const[g,e]=u.useState(!1),[h,m]=u.useState("text"),[f,y]=u.useState(""),p=(B,v)=>{m(B),y(v),e(!0)},C=()=>{e(!1)},F=()=>{e(!1)};return l(c,{children:[n(s,{onClick:()=>p("text","文本提示"),children:"文本提示"})," ",n(s,{onClick:()=>p("success","成功"),children:"成功提示"})," ",n(s,{onClick:()=>p("fail","失败"),children:"失败提示"})," ",n(s,{onClick:()=>p("loading","加载中"),children:"加载中提示"})," ",n(s,{onClick:()=>F(),children:"隐藏提示"}),n(a,{visible:g,type:h,title:f,onTimeout:C})]})}const T={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function r(){return n(c,{children:n(s,{onClick:()=>a.show("休息一下",{icon:n(E,{name:"bi-cup-hot"})}),children:"显示提示框"})})}const x={doc:`<h3>自定义图标</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};i.doc=T;k.doc=w;r.doc=x;d.doc=b;function S(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="toast-qing-ti-shi">Toast 轻提示<a class="doc-anchor" href="#toast-qing-ti-shi">#</a></h1>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-toast-bg</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-mask-dark<span class="token punctuation">)</span><span class="token punctuation">;</span>
