import{a as n,J as s,B as t,j as o,F as c,I as m,R as a}from"./index-be529937.js";import{D as p}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function e(){return n(s,{value:5,children:n(t,{children:"消息"})})}const h={doc:`<h3>基础使用</h3>
...
<pre class="language-scss"><code class="language-scss"><span class="token selector">:root </span><span class="token punctuation">{</span>
  ...
  <span class="token property">--s-badge-content-border-color</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-white<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">--s-badge-content-box-shadow</span><span class="token punctuation">:</span> 0 0 0 1px <span class="token function">var</span><span class="token punctuation">(</span>--s-badge-content-border-color<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token selector">[data-s-theme='dark'] </span><span class="token punctuation">{</span>
  <span class="token property">--s-badge-content-border-color</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--s-gray-800<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre>
