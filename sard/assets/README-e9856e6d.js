import{a as n,F as t,r as m,R as s}from"./index-ba304632.js";import{D as a}from"./Demo-5a7b5c0e.js";import{S as p}from"./index-b3aad3b6.js";import"./index.es-526e18cf.js";function e(){return n(t,{children:n(p,{placeholder:"数量"})})}const g={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function o(){const[i,d]=m.useState();return n(t,{children:n(p,{placeholder:"数量",value:i,onChange:d})})}const h={doc:`<h3>受控</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Stepper <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function r(){return n(t,{children:n(p,{placeholder:"数量",defaultValue:5,readOnly:!0})})}const b={doc:`<h3>只读</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Stepper <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};e.doc=g;o.doc=h;c.doc=y;u.doc=f;l.doc=w;k.doc=v;r.doc=b;function B(){return s.createElement("div",{className:"doc-content"},s.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="stepper-bu-jin-qi">Stepper 步进器<a class="doc-anchor" href="#stepper-bu-jin-qi">#</a></h1>
