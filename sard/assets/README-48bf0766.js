import{c as o,a as s,F as p,j as C,R as n}from"./index-b8e75f22.js";import{D as t}from"./Demo-3b19c6f8.js";import"./index.es-833d515d.js";const a=k=>{const{className:i,style:d,children:g,percent:h=0,color:m,trackColor:y,striped:f,animated:b,thickness:E,...w}=k,x=o("s-progress-bar",{"s-progress-bar-striped":f,"s-progress-bar-animated":b},i),B={backgroundColor:y,height:E,...d},v=o("s-progress-bar-trail"),F={width:`${h}%`,backgroundColor:m};return s("div",{...w,className:x,style:B,children:s("div",{className:v,style:F,children:g})})};function c(){return s(p,{children:s(a,{percent:50})})}const D={doc:`<h3>基础使用</h3>
