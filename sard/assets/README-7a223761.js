import{a,F as u,o as l,r as E,j as k,B as $,P as r,h as x,R as p}from"./index-b8e75f22.js";import{D as e}from"./Demo-3b19c6f8.js";import"./index.es-833d515d.js";function g(){const t=Array(1).fill(0).map((o,n)=>Array(60).fill(0).map((c,s)=>({value:`${n}-${s}`,label:`column${n}-item${s}`})));return a(u,{children:a(l,{columns:t})})}const w={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function f(){const t=Array(2).fill(0).map((o,n)=>Array(10).fill(0).map((c,s)=>({value:`${n}-${s}`,label:`column${n}-item${s}`})));return a(u,{children:a(l,{columns:t})})}const A={doc:`<h3>多列</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function y(){const t=Array(2).fill(0).map((i,d)=>Array(10).fill(0).map((B,m)=>({value:`${d}-${m}`,label:`column${d}-item${m}`}))),[o,n]=E.useState(["0-19","1-3"]),c=["0-7","1-0"],s=i=>{n(i)};return k(u,{children:[k($,{onClick:()=>n(c),children:["change to: ",JSON.stringify(c)]}),k("p",{children:["current value: ",JSON.stringify(o)]}),a(l,{columns:t,value:o,onChange:s})]})}const F={doc:`<h3>受控的</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function h(){const t=Array(2).fill(0).map((o,n)=>Array(10).fill(0).map((c,s)=>({value:`${n}-${s}`,label:`column${n}-item${s}${s%2===0?"-disabled":""}`,disabled:s%2===0})));return a(u,{children:a(l,{columns:t,defaultValue:["0-1","1-3"]})})}const C={doc:`<h3>禁用选项</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function b(){const t=Array(2).fill(0).map((o,n)=>Array(10).fill(0).map((c,s)=>({id:`${n}-${s}`,text:`column${n}-item${s}`})));return a(u,{children:a(l,{columns:t,fieldNames:{value:"id",label:"text"}})})}const D={doc:`<h3>自定义字段名</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Picker <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function v(){const t=Array(1).fill(0).map((o,n)=>Array(10).fill(0).map((c,s)=>({value:`${n}-${s}`,label:`column${n}-item${s}`})));return a(u,{children:k(r,{title:"请选择",children:[a(r.Outlet,{children:({setValue:o,value:n,triggerArgs:[,c=[]],setVisible:s})=>a(x,{readOnly:!0,placeholder:"请选择",value:(n==null?void 0:n.length)&&c.map(i=>i.label).join("/")||"",clearable:!0,onClear:()=>o(),onClick:()=>s(!0)})}),a(r.Target,{children:a(l,{columns:t})})]})})}const j={doc:`<h3>配合弹出框使用</h3>
