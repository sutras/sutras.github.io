import{r as o,j as k,F as r,a as n,B as a,H as d,R as t}from"./index-ba304632.js";import{D as g}from"./Demo-5a7b5c0e.js";import"./index.es-526e18cf.js";function c(){const[e,p]=o.useState(!1),[u,l]=o.useState("center"),s=i=>{p(!0),l(i)};return k(r,{children:[n(a,{onClick:()=>s("top"),children:"顶部"})," ",n(a,{onClick:()=>s("right"),children:"右边"})," ",n(a,{onClick:()=>s("bottom"),children:"底部"})," ",n(a,{onClick:()=>s("left"),children:"左边"})," ",n(a,{onClick:()=>s("center"),children:"居中"})," ",n(a,{onClick:()=>s("center-fade"),children:"居中淡入淡出"}),n(d,{visible:e,placement:u,onMaskClick:()=>{p(!1)},children:n("div",{style:{padding:"20px",background:"var(--s-emphasis-bg)"},children:"Popup"})})]})}const h={doc:`<h3>基础使用</h3>
