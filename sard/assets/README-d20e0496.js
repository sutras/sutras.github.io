import{r as l,j as p,F as k,a as n,B as v,P as t,f as g,h as m,C as d,M as r,i as P,D as w,o as D,R as c}from"./index-b8e75f22.js";import{D as u}from"./Demo-3b19c6f8.js";import{a as B}from"./area-bc21e994.js";import"./index.es-833d515d.js";function C(){const[a,s]=l.useState(!1);return p(k,{children:[n(v,{onClick:()=>s(!0),children:"显示弹出框"}),p(t,{visible:a,title:"标题",onClose:s,onConfirm:()=>g.show("确定"),onCancel:()=>g.show("取消"),children:[n("div",{children:"弹出框内容"}),n("div",{children:"弹出框内容"}),n("div",{children:"弹出框内容"})]})]})}const A={doc:`<h3>基础使用</h3>
