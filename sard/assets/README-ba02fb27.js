import{r as c,j as t,F as e,a as s,R as a}from"./index-093297df.js";import{B as l,Y as u,D as i}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import"./index.es-471f4c94.js";function p(){const[n,o]=c.useState(!0);return t(e,{children:[s(l,{onClick:()=>{o(!n)},children:"toggle"}),s("br",{}),s("br",{}),s(u,{visible:n,children:t("div",{style:{backgroundColor:"orange",padding:10},children:[s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"}),s("p",{children:"collapse"})]})})]})}const k={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token function">Component</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};p.doc=k;function C(){return a.createElement("div",{className:"doc-content"},a.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="collapse-zhe-die">Collapse 折叠<a class="doc-anchor" href="#collapse-zhe-die">#</a></h1>
