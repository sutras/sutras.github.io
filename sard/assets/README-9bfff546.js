import{r,j as l,F as u,a as n,B as a,a3 as s,R as p}from"./index-be529937.js";import{D as c}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function d(){const[o,t]=r.useState(!1);return l(u,{children:[n(a,{onClick:()=>t(!0),children:"显示对话框"}),n(s,{visible:o,title:"提示",message:"此功能暂时无法使用",onVisible:t})]})}const w={doc:`<h3>基础使用</h3>
...
<span class="token punctuation">}</span>`};function g(){const[o,t]=r.useState(!1);return l(u,{children:[n(a,{onClick:()=>t(!0),children:"显示对话框"}),n(s,{visible:o,showCancel:!0,title:"提示",message:"确定删除？",onVisible:t})]})}const b={doc:`<h3>确认框</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Dialog<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
