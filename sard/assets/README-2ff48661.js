import{c as A,a as n,L as _,j as l,F as m,q as E,H as $,r as b,B as S,R as c}from"./index-ba304632.js";import{D as f}from"./Demo-5a7b5c0e.js";import"./index.es-526e18cf.js";const H=p=>{const{className:s,style:u,children:r,title:a,label:t,color:g,loading:i,loadingProps:w,disabled:y,onClick:d,...v}=p,o=x=>{!y&&!i&&(d==null||d(x))},k=A("s-action-sheet-item",{"s-action-sheet-item-disabled":y,"s-action-sheet-item-loading":i},s),F={color:g,...u};return n("button",{...v,type:"button",className:k,style:F,onClick:o,disabled:y,children:i?n(_,{...w}):l(m,{children:[a&&n("div",{className:"s-action-sheet-item-title",children:a}),t&&n("div",{className:"s-action-sheet-item-label",children:t})]})})},C=p=>{const{className:s,children:u,visible:r,maskClosable:a=!0,actionClosable:t,title:g,description:i,itemList:w=[],cancel:y,onSelect:d,onCancel:v,onClose:o,popupProps:k={},...F}=p,{placement:x="bottom",...V}=k,P=E((e,h)=>{d==null||d(e,h),t&&(o==null||o(!1))}),R=E(e=>{var h;a&&((h=k==null?void 0:k.onMaskClick)==null||h.call(k,e),o==null||o(!1))}),z=E(()=>{v==null||v(!1),o==null||o(!1)}),q=A("s-action-sheet",{"s-action-sheet-headless":!g&&!i},s);return n($,{...V,visible:r,placement:x,onMaskClick:R,children:l("div",{...F,className:q,children:[(g||i)&&l("div",{className:"s-action-sheet-header",children:[g&&n("div",{className:"s-action-sheet-title",children:g}),i&&n("div",{className:"s-action-sheet-description",children:i})]}),n("div",{className:"s-action-sheet-body",children:u||w.map((e,h)=>b.createElement(H,{...e,key:h,onClick:M=>{var B;P(e,h),(B=e.onClick)==null||B.call(e,M)}}))}),y&&l(m,{children:[n("div",{className:"s-action-sheet-gap"}),n("button",{className:"s-action-sheet-cancel",onClick:z,children:y})]})]})})};function j(){const[p,s]=b.useState(!1);return l(m,{children:[n(S,{onClick:()=>s(!0),children:"显示动作面板"}),n(C,{visible:p,itemList:[{title:"动作1"},{title:"动作2"},{title:"动作3"}],actionClosable:!0,onSelect:(a,t)=>{console.log(a,t)},onClose:s})]})}const T={doc:`<h3>基础使用</h3>
