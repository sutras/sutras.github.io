import{a,F as u,o as l,r as E,j as k,B as $,P as r,h as x,R as p}from"./index-be529937.js";import{D as e}from"./Demo-af4ebbee.js";import"./index.es-58ca08bc.js";function g(){const t=Array(1).fill(0).map((o,n)=>Array(60).fill(0).map((c,s)=>({value:`${n}-${s}`,label:`column${n}-item${s}`})));return a(u,{children:a(l,{columns:t})})}const w={doc:`<h3>基础使用</h3>
