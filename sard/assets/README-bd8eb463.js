import{r as p,j as c,F as o,a as s,R as t}from"./index-093297df.js";import{B as l,I as f,b as r,D as e}from"./index-c0b255c8.js";import"./index-2e4736b8.js";import{N as u}from"./index-accd4f0d.js";import"./index.es-471f4c94.js";function d(){const[a,n]=p.useState(!1);return c(o,{children:[s(l,{onClick:()=>n(!0),children:"弹出键盘"}),s(u,{visible:a,onVisible:n})]})}const E={doc:`<h3>基础使用</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function m(){const[a,n]=p.useState(!1);return c(o,{children:[s(l,{onClick:()=>n(!0),children:"弹出键盘"}),s(u,{extraKey:"X",visible:a,onVisible:n})]})}const B={doc:`<h3>身份证</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> NumberKeyboard<span class="token punctuation">,</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function b(){const[a,n]=p.useState(!1);return c(o,{children:[s(l,{onClick:()=>n(!0),children:"弹出键盘"}),s(u,{title:c(o,{children:[s(f,{name:"bi-shield-lock-fill"}),s("span",{style:{marginLeft:5,verticalAlign:"middle"},children:"安全键盘"})]}),visible:a,onVisible:n})]})}const x={doc:`<h3>标题</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function h(){const[a,n]=p.useState(!1),[i,k]=p.useState("");return c(o,{children:[s(r,{value:i,readOnly:!0,onClick:()=>n(!0),placeholder:"请输入验证码",clearable:!0,onClear:k}),s(u,{value:i,onChange:k,maxLength:6,visible:a,onVisible:n})]})}const C={doc:`<h3>双向绑定</h3>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};function v(){const[a,n]=p.useState("");return s(o,{children:s(u,{value:a,onChange:n,maxLength:6,children:s(r,{value:a,readOnly:!0,placeholder:"请输入验证码",clearable:!0,onClear:n})})})}const V={doc:`<h3>简化键盘弹出</h3>
`,code:`<span class="token keyword">import</span> <span class="token punctuation">{</span> NumberKeyboard<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'sard'</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> useState <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">)</span>
<span class="token punctuation">}</span>`};d.doc=E;g.doc=w;m.doc=B;b.doc=x;y.doc=D;h.doc=C;v.doc=V;function K(){return t.createElement("div",{className:"doc-content"},t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h1 id="numberkeyboard-shu-zi-jian-pan">NumberKeyboard 数字键盘<a class="doc-anchor" href="#numberkeyboard-shu-zi-jian-pan">#</a></h1>
...
`}}),t.createElement("section",{className:"doc-section"},t.createElement(e,null,d),t.createElement(e,null,g),t.createElement(e,null,m),t.createElement(e,null,b),t.createElement(e,null,y),t.createElement(e,null,h),t.createElement(e,null,v)),t.createElement("section",{className:"doc-section",dangerouslySetInnerHTML:{__html:`<h2 id="api">API<a class="doc-anchor" href="#api">#</a></h2>
