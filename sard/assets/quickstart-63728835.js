import{R as n}from"./index-0f27af66.js";import{u as s}from"./useCodeTool-1da9412e.js";function t(){return s(),n.createElement("div",{className:"doc-content",dangerouslySetInnerHTML:{__html:`<h1 id="快速上手">快速上手<a class="doc-anchor" href="#快速上手">#</a></h1>
<h2 id="安装">安装<a class="doc-anchor" href="#安装">#</a></h2>
<div class="doc-card"><h3 id="通过npm安装">通过 npm 安装<a class="doc-anchor" href="#通过npm安装">#</a></h3>
...
</div><div class="doc-card"><h3 id="通过yarn安装">通过 yarn 安装<a class="doc-anchor" href="#通过yarn安装">#</a></h3>
...
</div><h2 id="配置">配置<a class="doc-anchor" href="#配置">#</a></h2>
<div class="doc-card"><h3 id="多平台配置">多平台配置<a class="doc-anchor" href="#多平台配置">#</a></h3>
...
</div><div class="doc-card"><h3 id="pxtransform配置">pxtransform 配置<a class="doc-anchor" href="#pxtransform配置">#</a></h3>
...
</div><h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-card"><h3 id="全局样式引入">全局样式引入<a class="doc-anchor" href="#全局样式引入">#</a></h3>
...
</div><h2 id="使用组件">使用组件<a class="doc-anchor" href="#使用组件">#</a></h2>
<div class="doc-card"><h3 id="Button组件示例">Button 组件示例<a class="doc-anchor" href="#Button组件示例">#</a></h3>
